...
// React-specific hooks and components come from your project's alias
import { Plate, usePlateEditor } from 'platejs/react';
// The core `Value` type comes from the @udecode/plate-common package
...
// This is the default content if nothing is saved in localStorage
...
export default function EditorDefault() {
  ...
  return (
    <Plate
      ...
      value={value}
      onChange={(newValue) => {
        // We can assert the type here since onChange provides it
        const typedValue = newValue as Value;
        setValue(typedValue);

        const contentString = JSON.stringify(typedValue);
