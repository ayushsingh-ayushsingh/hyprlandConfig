...
export default function EditorDefault() {
  // Add the <Value> generic for type safety
  ...
  // *** FIX #1 ***
  // `usePlateEditor` should only configure the editor's plugins, not its content.
  ...
  return (
    // *** FIX #2 ***
    // `value` and `onChange` are props of the <Plate> component itself.
    <Plate
      editor={editor}
      value={value}
